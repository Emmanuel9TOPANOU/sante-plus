    ...
    <div class="py-12 bg-slate-100 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <a href="<?php echo e(route('patient.history.index')); ?>" class="text-blue-600 font-bold flex items-center hover:underline">
                    ← Retour au dossier
                </a>
            ...
            <div class="bg-white shadow-2xl rounded-sm border-t-[12px] border-blue-600 p-12 md:p-16 relative overflow-hidden print:shadow-none print:border-none">
                ...
                <div class="flex justify-between items-start mb-16 border-b pb-8 border-slate-100">
                    <div>
                        <h2 class="text-2xl font-black text-slate-900">Dr. <?php echo e($prescription->medecin->name); ?></h2>
                        <p class="text-blue-600 font-bold uppercase tracking-widest text-sm"><?php echo e($prescription->medecin->specialite->nom ?? 'Médecin Généraliste'); ?></p>
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-slate-900 font-bold"><?php echo e(\Carbon\Carbon::parse($prescription->created_at)->translatedFormat('d F Y')); ?></p>
                    </div>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 uppercase tracking-tight"><?php echo e(Auth::user()->name); ?></h3>
                </div>
...
<div class="min-h-[400px]">
    ...
    <div class="space-y-8 text-slate-800 text-lg leading-relaxed">
        ...
        <?php echo nl2br(e($prescription->contenu ?? 'Aucun médicament spécifié')); ?>
                ...
                <div class="mt-20 pt-12 border-t border-slate-50 flex justify-between items-end">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-xs font-serif italic mt-2 text-slate-900">Dr. <?php echo e($prescription->medecin->name); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/patient/prescriptions/show.blade.php ENDPATH**/ ?>