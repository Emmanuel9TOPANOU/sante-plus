...
<body class="bg-[#F8FAFC] min-h-screen flex items-center justify-center p-6">
    ...
    <div class="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border border-slate-100 p-10 text-center animate-fade-in">
        ...
        <p class="text-slate-500 mb-8 leading-relaxed font-medium">
            Votre rendez-vous avec le <strong class="text-slate-900">Dr. <?php echo e($rendezvous->medecin->name ?? 'le médecin'); ?></strong> a bien été retiré du planning.
        </p>
        ...
        <div class="bg-slate-50 rounded-[2rem] p-6 mb-10 text-left border border-dashed border-slate-200">
            ...
            <p class="text-sm text-slate-700 font-bold">
                ...
                ?>
                <?php echo e($date->translatedFormat('l d F Y')); ?> <br>
                <span class="text-rose-500 italic">à <?php echo e($heure->format('H:i')); ?></span>
            </p>
        </div>
        ...
        <div class="space-y-4">
            ...
            <a href="<?php echo e(route('patient.rendezvous.index')); ?>" class="block text-[10px] text-slate-400 font-black uppercase tracking-widest hover:text-blue-600 transition-colors">
...
</html><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/patient/rendezvous/annulation_succes.blade.php ENDPATH**/ ?>