            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-5">
                    <div class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden sticky top-28">
                        ...
                        <form action="<?php echo e(route('doctor.availabilities.store')); ?>" method="POST" id="generateForm" class="p-6 space-y-5">
                            <?php echo csrf_field(); ?>
                            
                            
                            <?php if(Auth::user()->isSpecialist()): ?>
                                <div class="space-y-3">
                                    ...
                                    <div class="grid grid-cols-4 sm:grid-cols-7 gap-2">
                                        ...
                                        <?php $__currentLoopData = $jours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $nom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="cursor-pointer">
                                                <input type="checkbox" name="days[]" value="<?php echo e($val); ?>" class="hidden day-checkbox" <?php echo e(in_array($val, [1,2,3,4,5]) ? 'checked' : ''); ?>>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <input type="date" name="start_date" value="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d')); ?>" required 
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="date" name="end_date" value="<?php echo e(date('Y-m-d', strtotime('+1 month'))); ?>" min="<?php echo e(date('Y-m-d')); ?>" required 
                                           class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
                                </div>
                            </div>
                ...
                <div class="lg:col-span-7">
                    <div class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <?php if($availabilities->count() > 0): ?>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <?php $__currentLoopData = $availabilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="availability-card flex items-center justify-between p-4 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-md transition-all">
                                            <div class="flex items-center gap-4">
                                                <div class="flex flex-col items-center justify-center w-12 h-12 rounded-xl bg-blue-100">
                                                    ...
                                                    <span class="text-[8px] font-bold uppercase text-blue-400 leading-none"><?php echo e($item->date->translatedFormat('M')); ?></span>
                                                </div>
                                                <div>
                                                    <p class="text-[10px] font-black text-slate-400 uppercase"><?php echo e($item->date->translatedFormat('l')); ?></p>
                                                    <p class="text-sm font-black text-slate-800">
                                                        <?php echo e(\Carbon\Carbon::parse($item->start_time)->format('H:i')); ?> → <?php echo e(\Carbon\Carbon::parse($item->end_time)->format('H:i')); ?>
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <?php else: ?>
                                                    <form action="<?php echo e(route('doctor.availabilities.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Supprimer ce créneau ?')" class="inline">
                        ...
                        <?php if($availabilities->hasPages()): ?>
