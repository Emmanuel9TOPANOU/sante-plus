        ...
        <div>
            ...
            <div class="flex flex-col gap-1">
                <a href="<?php echo e(route('doctor.dashboard')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.dashboard') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                ...
                <a href="<?php echo e(route('doctor.patients.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.patients*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                ...
                <a href="<?php echo e(route('doctor.rendezvous.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.rendezvous*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                ...
                <a href="<?php echo e(route('doctor.analyses.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.analyses*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
        ...
        <div>
            ...
            <div class="flex flex-col gap-1">
                <a href="<?php echo e(route('doctor.availabilities.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.availabilities*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                ...
                <a href="<?php echo e(route('doctor.prescriptions.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.prescriptions*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                ...
                <a href="<?php echo e(route('doctor.messages.index')); ?>"
                    class="flex items-center px-4 py-3 rounded-xl transition-all duration-300 no-underline <?php echo e(request()->routeIs('doctor.messages*') ? 'bg-blue-600 text-white shadow-md' : 'text-blue-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
        ...
        <div class="max-w-7xl mx-auto space-y-8 md:space-y-14">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl md:text-4xl font-black text-blue-700 leading-tight">
                            Bonjour, <span class="text-blue-500"><?php echo e(Auth::user()->name); ?></span>
                        </h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <div class="bg-gradient-to-br from-blue-600 to-blue-400 p-7 rounded-3xl shadow-xl border-none flex flex-col items-start hover:scale-[1.03] transition-transform">
                    ...
                    <h3 class="text-4xl font-black text-white drop-shadow-lg"><?php echo e($rendezvous->count()); ?></h3>
                </div>
                <div class="bg-gradient-to-br from-indigo-600 to-indigo-400 p-7 rounded-3xl shadow-xl border-none flex flex-col items-start hover:scale-[1.03] transition-transform">
                    ...
                    <h3 class="text-4xl font-black text-white drop-shadow-lg"><?php echo e($totalPatients ?? 0); ?></h3>
                </div>
                <div class="bg-gradient-to-br from-rose-500 to-rose-400 p-7 rounded-3xl shadow-xl border-none flex flex-col items-start hover:scale-[1.03] transition-transform">
                    ...
                    <h3 class="text-4xl font-black text-white drop-shadow-lg"><?php echo e($messagesNonLus ?? 0); ?></h3>
                </div>
                <div class="bg-gradient-to-br from-blue-900 to-blue-700 p-7 rounded-3xl shadow-xl border-none flex flex-col items-start hover:scale-[1.03] transition-transform">
                    ...
                    <h3 class="text-lg font-black mt-2 text-white truncate drop-shadow-lg">
                        <?php echo e(Auth::user()->specialite->nom_specialite ?? 'Généraliste'); ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="<?php echo e(route('doctor.patients.index')); ?>" class="flex flex-col items-center justify-center p-4 md:p-6 bg-indigo-600 text-white rounded-3xl font-bold hover:scale-[1.02] transition shadow-lg shadow-indigo-100 no-underline text-center">
                ...
                <a href="<?php echo e(route('doctor.prescriptions.index')); ?>" class="flex flex-col items-center justify-center p-4 md:p-6 bg-emerald-600 text-white rounded-3xl font-bold hover:scale-[1.02] transition shadow-lg shadow-emerald-100 no-underline text-center">
                ...
                <a href="<?php echo e(route('doctor.availabilities.index')); ?>" class="flex flex-col items-center justify-center p-4 md:p-6 bg-blue-600 text-white rounded-3xl font-bold hover:scale-[1.02] transition shadow-lg shadow-blue-100 no-underline text-center">
                ...
                <a href="<?php echo e(route('doctor.rendezvous.index')); ?>" class="flex flex-col items-center justify-center p-4 md:p-6 bg-slate-900 text-white rounded-3xl font-bold hover:scale-[1.02] transition shadow-lg shadow-slate-200 no-underline text-center">
...
<div class="lg:col-span-8 overflow-hidden">
    <div class="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100">
        <div class="flex justify-between items-center mb-8">
            ...
            <span class="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-[10px] font-black">
                <?php echo e($rendezvous->count()); ?> RDV
            </span>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $rendezvous; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rdv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="group hover:bg-gray-50/50 transition-colors">
                            <td class="py-5 px-6 md:px-0 text-sm font-black text-blue-600">
                                <?php echo e(\Carbon\Carbon::parse($rdv->heure_rdv)->format('H:i')); ?>
                            ...
                            <td class="py-5">
                                <div class="flex items-center">
                                    ...
                                    <div class="w-9 h-9 rounded-xl bg-gray-100 flex items-center justify-center mr-3 text-xs font-black text-gray-500 uppercase group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">
                                        <?php echo e($rdv->patient ? substr($rdv->patient->name, 0, 1) : 'P'); ?>

                                    </div>
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-gray-800">
                                            <?php echo e($rdv->patient->name ?? 'Patient Inconnu'); ?>

                                        </span>
                                        <span class="text-[10px] text-gray-400 font-medium tracking-tight">ID: #<?php echo e($rdv->patient_id); ?></span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 text-sm text-gray-500 italic">
                                <?php echo e(Str::limit($rdv->motif ?? 'Consultation générale', 30)); ?>

                            </td>
                            <td class="py-5 text-right px-6 md:px-0">
                                
                                <?php if($rdv->statut === 'termine' || $rdv->statut === 'effectue'): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('doctor.consultations.create', ['rendezvous' => $rdv->id])); ?>" 
                    ...
                    <div class="bg-[#0F172A] text-white rounded-[2.5rem] p-8 shadow-xl shadow-blue-900/10 h-full">
                        ...
                        <div class="p-5 bg-slate-800/40 rounded-3xl border border-slate-700/50 min-h-[120px] flex items-center justify-center text-center">
                            <p class="text-xs text-slate-300 leading-relaxed italic font-medium">
                                <?php if(isset($derniereNote)): ?>
                                    "<?php echo e($derniereNote->contenu); ?>"
                                <?php else: ?>
    ...
    <div x-show="showNoteModal" 
        ...
        <div @click.away="showNoteModal = false" class="bg-white rounded-[2rem] p-6 md:p-10 max-w-md w-full shadow-2xl">
            ...
            <form action="<?php echo e(route('doctor.notes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/doctor/dashboard.blade.php ENDPATH**/ ?>