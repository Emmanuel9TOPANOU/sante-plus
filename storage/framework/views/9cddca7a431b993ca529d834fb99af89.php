                ...
                <div class="hidden lg:flex items-center gap-1">
                    ...
                    <a href="<?php echo e(route('doctor.messages.index')); ?>" 
                       class="nav-item px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center gap-2 <?php echo e(request()->routeIs('doctor.messages*') ? 'active' : 'text-slate-600 hover:bg-slate-50 hover:text-blue-600'); ?>">
                        ...
                        Messages
                        <?php if(($messagesNonLus ?? 0) > 0): ?>
                            <span class="ml-1 text-[10px] font-black bg-red-500 text-white px-1.5 py-0.5 rounded-full"><?php echo e($messagesNonLus); ?></span>
                        <?php endif; ?>
                    </a>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pb-6 border-b border-slate-200">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
                        Bonjour, <span class="text-blue-600">Dr. <?php echo e(Auth::user()->name); ?></span>
                    </h2>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
        ...
        <div class="p-6">
            ...
            <h3 class="text-3xl font-black text-slate-800"><?php echo e($rendezvous->count()); ?></h3>
    ...
    <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
        ...
        <div class="p-6">
            ...
            <h3 class="text-3xl font-black text-slate-800"><?php echo e($totalPatients ?? 0); ?></h3>
    ...
    <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <?php if(($messagesNonLus ?? 0) > 0): ?>
                    <span class="text-[10px] font-black text-rose-600 bg-rose-50 px-2.5 py-1.5 rounded-full border border-rose-100 animate-pulse"><?php echo e($messagesNonLus); ?> non lus</span>
                <?php else: ?>
                    <span class="text-[10px] font-black text-rose-600 bg-rose-50 px-2.5 py-1.5 rounded-full border border-rose-100">Tous lus</span>
                <?php endif; ?>
            </div>
            <h3 class="text-3xl font-black text-slate-800"><?php echo e($messagesNonLus ?? 0); ?></h3>
    ...
    <div class="group relative overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
        ...
        <div class="p-6">
            ...
            <h3 class="text-xl font-black text-white truncate"><?php echo e(Auth::user()->specialite->nom_specialite ?? 'Généraliste'); ?></h3>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <a href="<?php echo e(route('doctor.patients.index')); ?>" class="group flex flex-col items-center justify-center p-5 bg-white border border-slate-200 rounded-2xl font-semibold hover:bg-indigo-600 hover:text-white hover:border-transparent hover:shadow-xl transition-all duration-300 no-underline text-center">
                ...
                <a href="<?php echo e(route('doctor.availabilities.index')); ?>" class="group flex flex-col items-center justify-center p-5 bg-white border border-slate-200 rounded-2xl font-semibold hover:bg-blue-600 hover:text-white hover:border-transparent hover:shadow-xl transition-all duration-300 no-underline text-center">
                ...
                <a href="<?php echo e(route('doctor.rendezvous.index')); ?>" class="group flex flex-col items-center justify-center p-5 bg-white border border-slate-200 rounded-2xl font-semibold hover:bg-slate-800 hover:text-white hover:border-transparent hover:shadow-xl transition-all duration-300 no-underline text-center">
            ...
            <div class="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden">
                <div class="flex justify-between items-center px-6 py-5 border-b border-slate-100">
                    ...
                    <span class="px-3 py-1.5 bg-blue-100 text-blue-600 rounded-lg text-[10px] font-black"><?php echo e($rendezvous->count()); ?> RDV</span>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-blue-50/30 transition-colors group">
                                <td class="px-6 py-4">
                                    <span class="font-bold text-blue-600"><?php echo e(\Carbon\Carbon::parse($rdv->heure_rdv)->format('H:i')); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm"><?php echo e($rdv->patient->name ?? 'Patient'); ?></p>
                                            <p class="text-[9px] text-slate-400">ID: #<?php echo e($rdv->patient_id); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-slate-500 text-sm italic"><?php echo e(Str::limit($rdv->motif ?? 'Consultation générale', 40)); ?></p>
                                </td>
