...
<?php $component->withAttributes([]); ?>
        ...
        <div x-data="{ show: true }" 
            ...
            <div class="bg-white/10 backdrop-blur-2xl border border-emerald-500/50 p-4 rounded-3xl shadow-[0_0_30px_rgba(16,185,129,0.2)] flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-[9px] text-emerald-400/80 font-bold uppercase"><?php echo e(session('success')); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <video autoplay muted loop playsinline class="fixed inset-0 w-full h-full object-cover -z-30 video-background">
        <source src="<?php echo e(asset('assets/videos/18203708-hd_1920_1080_60fps.mp4')); ?>" type="video/mp4">
    </video>
    ...
    <div class="flex items-center justify-center min-h-screen relative z-10 py-10 px-6 montserrat" 
         x-data="{ 
            ...
            specialites: <?php echo e($specialites->map(fn($s) => ['id' => $s->id, 'nom' => $s->nom_specialite])->toJson()); ?>
            ...
            <div class="relative p-6 md:p-10 rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl bg-white/5 backdrop-blur-xl border border-white/10 overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-3">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="w-full pl-12 pr-4 compact-input bg-white/5 border border-white/10 rounded-2xl text-xs text-white placeholder-slate-500 focus:border-blue-500/50 outline-none transition-all" placeholder="Nom complet">
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full pl-12 pr-4 compact-input bg-white/5 border border-white/10 rounded-2xl text-xs text-white placeholder-slate-500 outline-none" placeholder="Adresse e-mail">
                    </div>

                    <div class="grid grid-cols-2 gap-3">
                        <input type="tel" name="telephone" value="<?php echo e(old('telephone')); ?>" required class="w-full px-4 compact-input bg-white/5 border border-white/10 rounded-2xl text-xs text-white placeholder-slate-500 outline-none" placeholder="Téléphone">
                        <input type="text" name="adresse" value="<?php echo e(old('adresse')); ?>" required class="w-full px-4 compact-input bg-white/5 border border-white/10 rounded-2xl text-xs text-white placeholder-slate-500 outline-none" placeholder="Ville">
                    </div>
                    ...
                    <div class="text-center pt-6 border-t border-white/10">
                        <p class="text-[10px] text-slate-400 uppercase">
                            Déjà inscrit ?
                            <a href="<?php echo e(route('login')); ?>" class="text-white font-bold hover:text-blue-400 underline ml-1">Se connecter</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/auth/register.blade.php ENDPATH**/ ?>