   ...
   <div class="relative group">
    ...
    <div class="relative">
        ...
        <select name="service_id" required
            ...
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($service->id); ?>" class="bg-slate-900 text-slate-300 py-3" <?php echo e(old('service_id') == $service->id ? 'selected' : ''); ?>>
    ...
    <div class="grid grid-cols-2 gap-3">
        <div class="relative group">
            ...
            <input type="tel" name="telephone" value="<?php echo e(old('telephone')); ?>" required 
                   pattern="^[0-9+\-\s]{8,20}$"
...
</script><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/auth/register.blade.php ENDPATH**/ ?>