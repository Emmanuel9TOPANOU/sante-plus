        ...
        <div class="max-w-7xl mx-auto space-y-6 md:space-y-8 animate-fade-in-up">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-200">
                ...
                <div class="glass-effect px-6 py-3.5 rounded-2xl shadow-sm text-sm font-medium text-slate-600 border border-white/50">
                    ...
                    Total: <?php echo e($patients->total()); ?> patients
                </div>
            </div>
                        ...
                        <div class="relative p-5 pb-0">
                            <div class="flex justify-between items-start">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-black text-slate-800 text-base"><?php echo e($patient->name); ?></h3>
                                        <p class="text-[10px] text-slate-400 font-semibold">
                                            <?php echo e($patient->patient?->sexe ?? 'Sexe inconnu'); ?> • 
                                            <?php echo e($patient->patient?->age ? $patient->patient->age . ' ans' : 'Âge inconnu'); ?>
                                ...
                                <div class="text-right">
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-50 text-blue-600 rounded-lg text-[9px] font-black">
                                        ...
                                        <?php echo e($patient->rendezvous_count ?? 0); ?> rdv
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5">
                            <div class="grid grid-cols-2 gap-3 mb-5">
                                <div class="bg-slate-50 rounded-xl p-3 text-center border border-slate-100">
                                    ...
                                    <p class="text-sm font-black <?php echo e($patient->patient?->groupe_sanguin ? 'text-rose-600' : 'text-slate-400'); ?>">
                                        <?php echo e($patient->patient?->groupe_sanguin ?? 'Inconnu'); ?>
                                ...
                                <div class="bg-slate-50 rounded-xl p-3 text-center border border-slate-100">
                                    ...
                                    <p class="text-[11px] font-bold text-slate-700 truncate">
                                        <?php echo e($patient->patient?->telephone ?? 'Non renseigné'); ?>
                            ...
                            <?php if($patient->patient?->allergies): ?>
                                <div class="mb-5 p-2.5 bg-amber-50 rounded-xl border border-amber-100">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <p class="text-[9px] font-bold text-amber-700">Allergies: <?php echo e($patient->patient->allergies); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
