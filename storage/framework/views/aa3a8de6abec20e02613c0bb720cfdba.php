...
<div x-data="{ mobileMenuOpen: false }" class="flex min-h-screen bg-gradient-to-br from-slate-100 to-white font-sans antialiased">
   ...
   <nav class="fixed top-0 left-0 right-0 bg-white shadow-lg border-b border-slate-100 z-50">
    ...
    <form action="<?php echo e(route('admin.specialites.index')); ?>" method="GET" class="relative w-full md:w-80">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-all duration-200 group">
                                        ...
                                        <td class="px-6 py-5 text-slate-500 text-sm max-w-md">
                                            <?php echo e(Str::limit($spec->description, 80) ?: '—'); ?>

                                        </td>
                                        <td class="px-6 py-5 text-right">
                                            <form action="<?php echo e(route('admin.specialites.destroy', $spec)); ?>" method="POST" onsubmit="return confirm('Supprimer définitivement cette discipline ?')" class="inline">
                ...
                <div class="lg:col-span-4">
                    <div class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden sticky top-28">
                        ...
                        <form action="<?php echo e(route('admin.specialites.store')); ?>" method="POST" class="p-6 space-y-5">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/admin/specialites/index.blade.php ENDPATH**/ ?>