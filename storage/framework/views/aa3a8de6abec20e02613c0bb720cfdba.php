...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav class="flex items-center space-x-2 text-[10px] font-black uppercase tracking-[0.2em] mb-6">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-slate-400 hover:text-blue-600 transition-colors no-underline flex items-center">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
            ...
            <form action="<?php echo e(route('admin.specialites.index')); ?>" method="GET" class="relative w-full md:w-72 group">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-8 space-y-6">
                <div class="flex items-center justify-between px-4">
                    ...
                    <span class="px-3 py-1 bg-white text-blue-600 text-[10px] font-black uppercase rounded-lg border border-slate-100 shadow-sm">
                        Total: <?php echo e($specialites->total()); ?>
                ...
                <div class="admin-table-wrapper">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php $__empty_1 = true; $__currentLoopData = $specialites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <td class="px-10 py-6">
                                    <div class="flex items-center gap-4">
                                        <div class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 font-black text-xs">
                                            <?php echo e(strtoupper(substr($spec->nom_specialite, 0, 2))); ?>

                                        </div>
                                        <span class="font-bold text-slate-800"><?php echo e($spec->nom_specialite); ?></span>
                                    </div>
                                </td>
                                <td class="px-10 py-6 text-slate-500"><?php echo e($spec->description); ?></td>
                                <td class="px-10 py-6 text-right">
                                    <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <form action="<?php echo e(route('admin.specialites.destroy', $spec)); ?>" method="POST" onsubmit="return confirm('Supprimer définitivement cette discipline ?')">
                ...
                <div class="mt-12 px-2">
                    <?php if($specialites->hasPages()): ?>
                        <nav class="flex items-center justify-between">
                            <div class="hidden sm:block">
                                <p class="text-[10px] font-black uppercase tracking-widest text-slate-400">
                                    <?php echo e($specialites->firstItem()); ?>-<?php echo e($specialites->lastItem()); ?> <span class="mx-1 text-slate-200">/</span> <?php echo e($specialites->total()); ?>

                                </p>
                            </div>
                            <div class="flex gap-2">
                                <?php if($specialites->onFirstPage()): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($specialites->previousPageUrl()); ?>" class="p-4 bg-white border border-slate-100 text-blue-600 rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M15 19l-7-7 7-7"/></svg>
                                    </a>
                                <?php endif; ?>

                                <?php if($specialites->hasMorePages()): ?>
                                    <a href="<?php echo e($specialites->nextPageUrl()); ?>" class="p-4 bg-white border border-slate-100 text-blue-600 rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-slate-900 p-8 rounded-[3rem] shadow-2xl shadow-blue-900/20 relative overflow-hidden group">
                    ...
                    <form action="<?php echo e(route('admin.specialites.store')); ?>" method="POST" class="space-y-6 relative z-10">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-2">
...
</style><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/admin/specialites/index.blade.php ENDPATH**/ ?>