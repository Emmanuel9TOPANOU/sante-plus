    ...
    <div class="flex items-center justify-center min-h-screen px-6 font-['Montserrat']">
        <div class="w-full max-w-lg text-center">
            <div class="relative p-10 rounded-[3.5rem] bg-white/5 backdrop-blur-3xl border border-white/10 shadow-2xl overflow-hidden">
                ...
                <?php if(auth()->user()->medecin && auth()->user()->medecin->est_valide): ?>
                    ...
                    <div class="space-y-6 mb-8">
                        ...
                        <a href="<?php echo e(route('doctor.dashboard')); ?>" class="inline-block w-full py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[10px] uppercase tracking-[0.2em] rounded-2xl shadow-lg shadow-emerald-900/20 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div class="space-y-4 mb-8">
                        ...
                        <div class="inline-block px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
                            <p class="text-[9px] text-blue-400 font-black uppercase tracking-[0.2em]">
                                Matricule : <?php echo e(auth()->user()->medecin->matricule ?? 'ANALYSE...'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/attente-validation.blade.php ENDPATH**/ ?>