...
<?php $component->withAttributes([]); ?>
    <div class="py-6 md:py-12 bg-[#F8FAFC] min-h-screen" x-data="prescriptionForm()">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="<?php echo e(route('doctor.prescriptions.index')); ?>" class="group inline-flex items-center text-gray-400 hover:text-blue-600 transition-all">
            ...
            <div class="bg-white shadow-2xl shadow-blue-900/5 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 border border-gray-100">
                ...
                <form action="<?php echo e(route('doctor.prescriptions.store')); ?>" method="POST" class="space-y-6 md:space-y-8">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        function prescriptionForm() {
            return {
                ...
                allConsultations: <?php echo json_encode($consultations); ?>,
