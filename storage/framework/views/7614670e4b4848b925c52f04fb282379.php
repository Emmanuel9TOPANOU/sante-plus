        ...
        <?php if(session('info')): ?>
            <div x-data="{ show: true }" 
                ...
                <div class="flex-1">
                    ...
                    <p class="text-[8px] text-blue-400/90 font-bold uppercase leading-tight"><?php echo e(session('info')); ?></p>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if(session('status')): ?>
            <div x-data="{ show: true }" 
                ...
                <div class="flex-1">
                    ...
                    <p class="text-[8px] text-emerald-400/90 font-bold uppercase leading-tight"><?php echo e(session('status')); ?></p>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="relative p-8 rounded-[2.5rem] shadow-2xl bg-white/10 backdrop-blur-2xl border border-white/20 overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus class="w-full pl-14 pr-4 py-4 bg-white/5 border border-white/10 rounded-2xl text-sm text-white placeholder-slate-400 focus:border-blue-500 outline-none" placeholder="Adresse e-mail">
                    </div>
                    ...
                    <div class="flex justify-between items-center px-1">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] text-blue-400 hover:text-blue-300 uppercase">Oublié ?</a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="text-center pt-6 border-t border-white/10">
                        <p class="text-[10px] text-slate-400 uppercase">
                            Nouveau ici ?
                            <a href="<?php echo e(route('register')); ?>" class="text-white font-bold hover:text-blue-400 underline ml-1">Créer un profil</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/auth/login.blade.php ENDPATH**/ ?>