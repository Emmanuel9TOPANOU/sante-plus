                        ...
                        <div class="p-6 md:p-8">
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="w-full lg:w-1/3">
                                    ...
                                    <div class="flex items-center gap-3 mb-4">
                                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-black text-lg shadow-md">
                                            <?php echo e(substr($analyse->user->name ?? 'P', 0, 2)); ?>

                                        </div>
                                        <div>
                                            <h3 class="font-black text-slate-800 text-lg"><?php echo e($analyse->user->name ?? 'Patient inconnu'); ?></h3>
                                            <p class="text-[10px] text-slate-400">ID: #<?php echo e($analyse->user_id); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 space-y-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <p class="text-sm font-bold text-blue-600 uppercase"><?php echo e($analyse->type_analyse); ?></p>
                                        </div>
                                        <p class="text-slate-500 text-sm italic bg-slate-50 p-3 rounded-xl">
                                            "<?php echo e($analyse->observations ?? 'Aucune observation particulière'); ?>"
                                        </p>
                                    </div>
                                    
                                    <div class="mt-6 pt-4 border-t border-slate-100">
                                        <p class="text-[9px] text-slate-400 uppercase font-black tracking-wider">Prescrit par</p>
                                        <p class="text-sm font-bold text-slate-700">Dr. <?php echo e($analyse->doctor->name ?? Auth::user()->name); ?></p>
                                        <p class="text-[10px] text-slate-400 mt-1"><?php echo e($analyse->created_at->format('d/m/Y à H:i')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="w-full lg:w-2/3">
                                    <?php if($analyse->statut == 'en_attente'): ?>
                                        <form action="<?php echo e(route('doctor.analyses.store_result', $analyse->id)); ?>" method="POST" class="space-y-5">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="space-y-5">
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <div class="bg-slate-50 p-5 rounded-xl border border-slate-100">
                                                    ...
                                                    <p class="text-xs font-bold text-slate-700"><?php echo e(\Carbon\Carbon::parse($analyse->date_prelevement)->format('d/m/Y H:i')); ?></p>
                                                    <p class="text-[9px] text-slate-400 mt-1"><?php echo e($analyse->laboratoire_nom); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-slate-50 p-5 rounded-xl border border-slate-100 relative">
                                                ...
                                                <p class="text-slate-600 text-sm leading-relaxed italic mt-2">
                                                    "<?php echo e($analyse->interpretation ?? 'Aucune interprétation saisie.'); ?>"
                                                </p>
                                                <div class="mt-4 flex justify-between items-center pt-3 border-t border-slate-200">
                                                    <div>
                                                        ...
                                                        <p class="text-xs font-bold text-slate-800">Dr. <?php echo e($analyse->biologiste_nom); ?></p>
                                                    </div>
                                                    <a href="<?php echo e(route('doctor.analyses.download', $analyse->id)); ?>" 
