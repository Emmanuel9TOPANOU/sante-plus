                        ...
                        <div class="p-5 md:p-8">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div class="self-start sm:self-center">
                                    <span class="px-3 py-1.5 rounded-lg <?php echo e($consultation->statut === 'termine' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-blue-50 text-blue-600 border-blue-100'); ?> text-[9px] md:text-[10px] font-black uppercase tracking-widest border">
                                        <?php echo e($consultation->statut === 'termine' ? 'Terminé' : ucfirst($consultation->statut)); ?>
                                        ...
                                        <?php $__currentLoopData = $consultation->consultation->analyses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analyse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center justify-between p-3 bg-blue-50/30 border border-blue-100 rounded-xl hover:bg-blue-50 transition-all">
                                                <div class="flex items-center">
                                                    <div class="w-8 h-8 rounded-lg <?php echo e($analyse->statut === 'termine' ? 'bg-emerald-100 text-emerald-600' : 'bg-amber-100 text-amber-600'); ?> flex items-center justify-center mr-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[10px] text-gray-400 font-medium uppercase"><?php echo e($analyse->statut === 'termine' ? 'Disponible' : 'En cours'); ?></p>
                                                    </div>
                                                </div>
                                                <?php if($analyse->statut === 'termine' && $analyse->pdf_path): ?>
                                                    <a href="<?php echo e(asset('storage/' . $analyse->pdf_path)); ?>" target="_blank" class="p-2 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors">
