...
<a href="<?php echo e(url('/')); ?>" class="flex items-center gap-3 lg:gap-4 group no-underline border-none">
    ...
    <section id="hero" class="relative min-h-screen flex items-center pt-24 lg:pt-32 pb-16 overflow-hidden">
        ...
        <div class="absolute inset-0 w-full h-full -z-10">
            <video autoplay muted loop playsinline class="w-full h-full object-cover brightness-90">
                <source src="<?php echo e(asset('assets/videos/vid2.mp4')); ?>" type="video/mp4">
            </video>
...
<div class="flex-1 text-left"> 
    ...
    <div class="flex flex-col sm:flex-row items-start justify-start gap-4 lg:gap-6">
        ...
        <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto flex items-center justify-center gap-4 px-10 py-5 bg-white backdrop-blur-md rounded-2xl lg:rounded-3xl border border-slate-100 shadow-sm hover:bg-white transition group">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-24 mb-24 lg:mb-40">
                <div class="w-full lg:w-[45%] flex-shrink-0" data-aos="fade-right">
                    <img src="<?php echo e(asset('assets/images/img3.jpg')); ?>" 
                        alt="Gestion Santé+" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-12 lg:gap-y-16 w-full" data-aos="fade-left">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="space-y-3 lg:space-y-4 text-center sm:text-left">
                        <div class="text-blue-600 font-black text-3xl lg:text-4xl mb-2"><?php echo e($arg['n']); ?></div>
                        <h4 class="font-black text-slate-900 uppercase text-lg lg:text-2xl tracking-tight"><?php echo e($arg['t']); ?></h4>
                        <p class="text-slate-500 text-base lg:text-xl leading-relaxed"><?php echo e($arg['d']); ?></p>
                    </div>
            ...
            <div class="flex flex-col flex-col-reverse lg:flex-row-reverse items-center gap-12 lg:gap-24">
                <div class="w-full lg:w-[45%] flex-shrink-0" data-aos="fade-left">
                    <img src="<?php echo e(asset('assets/images/img4.jpg')); ?>" 
                        alt="Soin Patient" 
                        class="w-full h-[350px] lg:h-[550px] object-cover rounded-3xl ">
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-12 lg:gap-y-16 w-full" data-aos="fade-right">
                    ...
                    <div class="space-y-3 lg:space-y-4 text-center sm:text-left">
                        <div class="text-indigo-600 font-black text-3xl lg:text-4xl mb-2"><?php echo e($arg['n']); ?></div>
                        <h4 class="font-black text-slate-900 uppercase text-lg lg:text-2xl tracking-tight"><?php echo e($arg['t']); ?></h4>
                        <p class="text-slate-500 text-base lg:text-xl leading-relaxed"><?php echo e($arg['d']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <section id="mission" class="py-20 lg:py-24 bg-slate-50 w-full overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-20 lg:mb-24">
            ...
            <div class="w-full lg:w-[45%] group flex justify-center lg:justify-start" data-aos="fade-right">
                <div class="relative transition-transform duration-700 ease-in-out group-hover:scale-105 w-full flex justify-center items-center">
                    ...
                    <img src="<?php echo e(asset('assets/images/pexels-taiyesalawu-36450260.jpg')); ?>" 
                         alt="Interface Santé+" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 border-t border-slate-200 pt-16">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group text-center space-y-6 p-8 rounded-[2rem] transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5" 
                data-aos="zoom-in" data-aos-delay="<?php echo e(100 * ($key + 1)); ?>">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="group relative bg-white p-8 lg:p-10 rounded-3xl border border-slate-100 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl" data-aos="fade-up">
                    <div class="w-12 lg:w-14 h-12 lg:h-14 bg-<?php echo e($feat['c'] == 'slate-900' ? 'slate-900' : $feat['c'].'-50'); ?> text-<?php echo e($feat['c'] == 'slate-900' ? 'white' : $feat['c'].'-600'); ?> rounded-2xl flex items-center justify-center mb-6 lg:mb-8 group-hover:scale-110 transition-all duration-500 shadow-sm">
                        <i class="fa-solid <?php echo e($feat['i']); ?> text-xl lg:text-2xl"></i>
                    </div>
                    <h3 class="text-xl lg:text-2xl font-black text-slate-900 mb-4 tracking-tight group-hover:text-blue-600 transition-colors uppercase"><?php echo e($feat['t']); ?></h3>
...
</html><?php /**PATH C:\Users\POSTE DETRAVAIL\Desktop\Soutenance\Santé+\resources\views/welcome.blade.php ENDPATH**/ ?>