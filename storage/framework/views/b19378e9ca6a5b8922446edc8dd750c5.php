    ...
    <aside 
        ...
        <div id="contactList" class="flex-1 overflow-y-auto p-3 space-y-2 scrollbar-thin scrollbar-thumb-blue-100 scrollbar-track-white">
            ...
            <a href="<?php echo e(route('doctor.messages.show', $patient->id)); ?>"
                ...
                <?php echo e($isActive ? 'bg-blue-50 shadow-md border-l-4 border-blue-600' : 'hover:bg-blue-100/60 hover:shadow-lg'); ?>">
                <div class="relative">
                    <div class="w-11 h-11 <?php echo e($isActive ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white'); ?> flex items-center justify-center rounded-2xl font-black transition-colors shadow">
                ...
                <div class="ml-3 flex-1 truncate">
                    ...
                    <p class="text-[10px] <?php echo e($isActive ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400'); ?> font-bold uppercase tracking-tight truncate mt-0.5">
                        Dernier échange
                    </p>
                </div>
                <?php if($isActive): ?>
    ...
    <main class="flex-1 flex flex-col h-full relative min-w-0">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-100 bg-white/80 backdrop-blur-md">
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route('doctor.dashboard')); ?>" class="p-2.5 bg-white rounded-xl shadow-sm border border-gray-50 text-gray-400 hover:text-blue-600 transition-colors">
        ...
        <div class="flex-1 flex flex-col bg-[#F8FAFC]">
            <?php if(isset($activeContact)): ?>
                ...
                <div class="p-4 bg-white border-t border-gray-100">
                    <form action="<?php echo e(route('doctor.messages.store')); ?>" method="POST"
                        ...
                        <input type="text" name="content" required autocomplete="off"
                            placeholder="Écrivez votre message à <?php echo e(explode(' ', $activeContact->name)[0]); ?>..."
