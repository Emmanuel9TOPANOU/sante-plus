...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:border-blue-200 border-l-4 border-l-blue-600 transition-all duration-300 group">
        ...
        <h3 class="text-3xl font-bold text-black mb-1">{{ $prochainsRendezVous->count() }}</h3>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:border-blue-200 border-l-4 border-l-amber-500 transition-all duration-300 group">
        ...
        <h3 class="text-3xl font-bold text-black mb-1">{{ $analyses ?? 0 }}</h3>
        <p class="text-slate-400 text-[11px] font-bold uppercase tracking-widest">Analyses</p>
    </div>

    {{-- ID Patient (Design Inverse) --}}
    <div class="bg-black rounded-2xl shadow-lg border border-black p-6 hover:bg-gray-900 transition-all duration-300 relative overflow-hidden group">
        {{-- Décoration de bordure interne subtile --}}
        ...
        <p class="text-gray-400 text-[11px] font-bold uppercase tracking-widest">ID Patient</p>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    <a href="{{ route('patient.rendezvous.create') }}" class="group flex flex-col items-center justify-center p-5 bg-white border border-blue-100 text-slate-600 rounded-2xl font-semibold hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md transition-all duration-300 no-underline text-center">
                    ...
                    <a href="{{ route('patient.lab_results.index') }}" class="group flex flex-col items-center justify-center p-5 bg-white border border-blue-100 text-slate-600 rounded-2xl font-semibold hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md transition-all duration-300 no-underline text-center">
                        <div class="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center mb-2.5 group-hover:bg-white/20 transition-all">
                    ...
                    <a href="{{ route('patient.history.index') }}" class="group flex flex-col items-center justify-center p-5 bg-white border border-blue-100 text-slate-600 rounded-2xl font-semibold hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md transition-all duration-300 no-underline text-center">
                        <div class="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center mb-2.5 group-hover:bg-white/20 transition-all">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                                        ...
                                        <tr class="group hover:bg-blue-50/30 transition-all">
                                            <td class="py-4 px-6">
                                                <div class="flex flex-col gap-1">
                                                    <span class="text-sm font-semibold text-slate-800">{{ \Carbon\Carbon::parse($rdv->date_rdv)->translatedFormat('d M Y') }}</span>
                                                    <span class="text-[10px] text-white font-bold uppercase bg-blue-600 px-2.5 py-1 rounded-lg self-start shadow-sm">{{ $rdv->heure_rdv }}</span>
                                                </div>
                                            </td>
                                            <td class="py-4 px-3">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="text-sm font-semibold text-slate-700">Dr. {{ $rdv->medecin->name ?? 'Médecin' }}</span>
                                                </div>
                                            </td>
                                            <td class="py-4 px-3">
                                        ...
                                        <tr>
                                            <td colspan="4" class="py-12 text-center text-slate-500">
                                                <div class="flex flex-col items-center gap-2">
                                                    ...
                                                    <a href="{{ route('patient.rendezvous.create') }}" class="mt-2 text-sm text-blue-600 font-semibold underline">Prendre un rendez-vous</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
                ...
                {{-- COLONNE DE DROITE (Suivi Médical) --}}
