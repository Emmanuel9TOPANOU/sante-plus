...
<td class="px-6 py-5">
    <span class="block font-bold text-blue-900">
        Dr. {{ $ordonnance->medecin->name ?? 'Médecin non assigné' }}
    </span>
    <span class="text-[10px] uppercase font-black text-blue-400 tracking-tighter">
        {{ $ordonnance->medecin->specialite->nom ?? 'Médecine Générale' }}
    </span>
</td>
                                    ...
                                    <td class="px-6 py-5 text-right">
                                        <div class="flex justify-end items-center space-x-2">
                                            {{-- Route Détails : patient.prescriptions.show --}}
                                            <a href="{{ route('patient.prescriptions.show', $ordonnance->id) }}" 
                                            ...
                                            {{-- Route PDF : patient.prescriptions.download --}}
                                            <a href="{{ route('patient.prescriptions.download', $ordonnance->id) }}" 
