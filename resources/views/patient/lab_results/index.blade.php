                ...
                <div class="md:hidden divide-y divide-blue-50">
                    @forelse ($analyses as $analyse)
                        ...
                        <div class="p-6">
                            ...
                            @if($status == 'termine')
                                <a href="{{ route('patient.lab_results.download', $analyse->id) }}" class="w-full flex items-center justify-center space-x-2 bg-slate-900 hover:bg-blue-600 text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl active:scale-95 transition-transform">
