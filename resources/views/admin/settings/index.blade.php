<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto py-10 px-6 space-y-12">
        ...
        {{-- ================= FORMULAIRE ================= --}}
        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8 animate-fade-in" style="animation-delay: 0.1s">
            @csrf
            @method('PATCH')
                ...
                <div class="relative bg-white p-10 rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,0.04)] border border-slate-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                        ...
                        <div class="md:col-span-2 space-y-3">
                            ...
                            @error('clinic_name') <p class="text-rose-500 text-[10px] font-bold uppercase ml-2 tracking-tighter">{{ $message }}</p> @enderror
                        </div>
