                    ...
                    <div class="w-full lg:w-80 border-r border-slate-100 bg-slate-50/30">
                        ...
                        <div id="contactList" class="overflow-y-auto h-[500px] lg:h-[540px] p-2 space-y-1">
                            ...
                            <a href="{{ route('doctor.messages.show', $secretaire->id) }}"
                                ...
                                class="contact-item flex items-center gap-3 p-3 rounded-xl transition-all duration-200 {{ $isActive ? 'bg-blue-50 border-l-4 border-blue-600' : 'hover:bg-slate-100' }}">
                            ...
                            <a href="{{ route('doctor.messages.show', $patient->id) }}"
                                ...
                                <div class="relative">
                                    ...
                                    @if($patient->unread > 0)
                                        <span class="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">{{ $patient->unread }}</span>
                                    @endif
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-slate-800 text-sm truncate">{{ $patient->name }}</p>
                    ...
                    <div class="flex-1 flex flex-col">
                        @if(isset($activeContact))
                            ...
                            <div class="flex items-center gap-3 p-4 border-b border-slate-100 bg-white">
                                ...
                                <div>
                                    <h3 class="font-bold text-slate-800">{{ $activeContact->name }}</h3>
                            ...
                            <div class="p-4 border-t border-slate-100 bg-white">
                                <form action="{{ route('doctor.messages.store') }}" method="POST" class="flex gap-2">
                                    @csrf
