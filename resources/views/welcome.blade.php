        ...
        <img src="{{ asset('assets/images/logo.png') }}" 
            ...
            <div class="flex items-center space-x-3 lg:space-x-4">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="bg-blue-600 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl lg:rounded-2xl text-[10px] lg:text-xs font-black uppercase tracking-widest hover:bg-blue-700 transition ">Prendre RDV</a>
                @endauth
            </div>
...
<div class="flex-1 text-left"> {{-- Forcé à gauche --}}
    ...
    <div class="flex flex-col sm:flex-row items-start justify-start gap-4 lg:gap-6">
        ...
        {{-- Bouton Prendre RDV --}}
        <a href="{{ route('register', ['role' => 'medecin']) }}" class="w-full sm:w-auto px-10 lg:px-12 py-5 lg:py-6 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl lg:rounded-3xl hover:-translate-y-1 transition-all uppercase tracking-widest text-[10px] lg:text-xs flex items-center justify-center gap-3">
